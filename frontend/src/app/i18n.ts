...
const english = {
  exportSuccess: 'Your PDF is ready!',
  exportSuccessText: 'Your download has started. You can find the PDF in your downloads.',
  downloadAgain: 'Download again',
  editAnother: 'Edit another PDF',
  continueEditing: 'Return to this document',
  ...
  supportText: 'If this free tool helps you, you can buy us a coffee.',
} as const;
...
const translations: Record<Language, TranslationTable> = {
  en: english,
  fr: {
    exportSuccess: 'Votre PDF est prêt !', exportSuccessText: 'Le téléchargement a été lancé. Retrouvez votre PDF dans vos téléchargements.', downloadAgain: 'Télécharger à nouveau', editAnother: 'Modifier un autre PDF', continueEditing: 'Revenir à ce document',
    tagline: 'Remplissez et signez vos documents directement dans votre navigateur',
    seoHeading: 'Remplir et signer un PDF en ligne', seoLead: 'Ajoutez du texte, des dates, des cases et votre signature à n’importe quel PDF en quelques clics.', howTitle: 'Un éditeur PDF simple et privé', howText: 'Choisissez un PDF, placez les champs nécessaires, puis téléchargez votre document complété. Aucun compte, filigrane ou téléversement de document n’est requis.', featurePrivate: 'Privé par conception', featurePrivateText: 'Votre document est traité directement dans votre navigateur.', featureFree: 'Gratuit', featureFreeText: 'Remplissez et signez des PDF sans inscription ni filigrane.', featureFlexible: 'Flexible', featureFlexibleText: 'Placez et redimensionnez les champs où vous le souhaitez.', support: 'Soutenir ce projet', supportText: 'Si cet outil gratuit vous aide, vous pouvez nous offrir un café.',
  ...
  es: {
    exportSuccess: '¡Tu PDF está listo!', exportSuccessText: 'La descarga ha comenzado. Encontrarás el PDF en tus descargas.', downloadAgain: 'Descargar de nuevo', editAnother: 'Editar otro PDF', continueEditing: 'Volver a este documento',
  ...
  zh: {
    ...
    seoHeading: '在线填写和签署 PDF', seoLead: '只需几次点击，即可向任何 PDF 添加文本、日期、复选框和签名。', howTitle: '简单且私密的 PDF 编辑器', howText: '选择 PDF，放置所需字段，然后下载填写完成的文档。无需账户、无水印，也无需上传文档。', featurePrivate: '默认保护隐私', featurePrivateText: '您的文档直接在浏览器中处理。', featureFree: '免费使用', featureFreeText: '无需注册或水印即可填写和签署 PDF。', featureFlexible: '灵活', featureFlexibleText: '可在文档任意位置放置和调整字段大小。', support: '支持这个项目', supportText: '如果这个免费工具对您有帮助，您可以请我们喝杯咖啡。',
  },
};
